...
def _jupyterlab_variableinspector_displayfigure(widget):
    display.display(widget.canvas)

def _jupyterlab_variableinspector_displaydataframe(widget):
    import qgrid
    qgrid.show_grid(widget)
...
const scripts = {
    python: {
        initScript: py_script,
        queryCommand: '_jupyterlab_variableinspector_dict_list()',
        matrixQueryCommand: '_jupyterlab_variableinspector_getmatrixcontent',
        figureCommand: '_jupyterlab_variableinspector_displayfigure',
        dataFrameCommand: '_jupyterlab_variableinspector_displaydataframe',
...
export function getScript(lang: 'python' | 'R' | 'scala'): LanguageModel | undefined {
    if (lang in scripts) {
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        return scripts[lang] as any;
    }
}
